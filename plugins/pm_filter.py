...
import os
req_channel = int(os.environ.get('REQ_CHANNEL','-1001780805995'))
...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://telegram.me/TeamLeech')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕ Join For updates ⭕', url='https://t.me/TeamLeech')
            ],[
    ...
    if not spoll:
        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                ...
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("━ • │▌║  ᗩᗪᗪ ʍɛ 2 ᑌᖇ Ǥᖇᗝᑌᑭ  ║▌│ • ━", url=f'http://t.me/{temp.U_NAME}?startgroup=true')],[InlineKeyboardButton("✪ Dev Ch- ✪", url="https://t.me/TeamLeech"), InlineKeyboardButton("✪ TEAM MOVIES ✪", url="https://t.me/+ACwXEFrK7rg0NjY1"), InlineKeyboardButton("✪ Main Ch- ✪", url="https://t.me/+ACwXEFrK7rg0NjY1")],[InlineKeyboardButton("╚»♥️Thank u TEAM MOVIES™♥️«╝", callback_data="close_data")]]))
